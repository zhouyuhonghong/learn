      ...
      <div class="col-md-8">      
        <form action="/music/do_modify">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="musicname" name="musicname" value="${music.musicname}" placeholder="请输入歌名">
            </div>
            <div class="form-group">
                <label for="singer">歌手</label>
                <input type="text" class="form-control" id="singer" name="singer" value="${music.singer}" placeholder="请输入歌手">
            </div>
